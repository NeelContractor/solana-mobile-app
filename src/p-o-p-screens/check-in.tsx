...
// ✅ Your machine's local IP — run `ifconfig | grep inet` to find it
    ...
    async function handleCheckIn() {
        ...
        try {
            ...
            await transact(async (wallet) => {
                ...
                // ✅ Mint via server — no UMI in the app
                setStatus("Minting your badge...");
                await fetch(MINT_SERVER_URL, {
                method: "POST",
...
//         const MERKLE_TREE = umiPublicKey("5vpGA6PhqEWXdvGG5aoo18aYfqvGtFPpmzDyNy4qQsdn");
